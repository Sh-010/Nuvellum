// parse-verification.js — GENERATED by scripts/build-n8n-snippets.mjs. Do not edit in n8n;
...
// ---- node body -------------------------------------------------------------
return $input.all().map(item => ({ json: { ...item.json, verification: parseVerification(item.json.verificationText ?? item.json.text ?? '') } }));
