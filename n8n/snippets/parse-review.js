// parse-review.js — GENERATED by scripts/build-n8n-snippets.mjs. Do not edit in n8n;
...
// ---- node body -------------------------------------------------------------
return $input.all().map(item => ({ json: { ...item.json, review: parseEditorialReview(item.json.reviewText ?? item.json.text ?? '') } }));
